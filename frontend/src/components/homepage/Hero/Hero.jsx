    ...
    <>
      ...
      <div className="hero">
        ...
        <div className="heading">
          ...
          <p className="desc">
            Fresco Guard employs data-driven technology, real-time updates, and
            user feedback to revolutionize food storage, minimizing spoilage and
            contributing to a significant reduction in food waste
          </p>
